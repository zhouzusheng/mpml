...
typedef sre_int_t(*pike_callback)(sre_int_t id, sre_int_t start, sre_int_t end, void* userData);
...
SRE_API sre_int_t sre_vm_pike_exec(sre_vm_pike_ctx_t *ctx, sre_char *input,
    size_t len, unsigned eof, sre_int_t **pending_matched, pike_callback callback, void* userData);
SRE_API void sre_vm_pike_reset_ctx(sre_vm_pike_ctx_t *ctx);
