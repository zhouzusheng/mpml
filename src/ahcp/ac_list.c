 ...
 */
ac_error_code ac_list_free_simple_item(void *item, void *data)
{
	free(item);
	return AC_SUCCESS;
}
 ...
 * freed.
 */
ac_error_code ac_list_free_keep_item(void *item, void *data)
{
	return AC_SUCCESS;
}
 ...
 */
ac_error_code
ac_list_free(ac_list *self, ac_free_function free_item, void *free_data)
{
 ...
 */
ac_error_code ac_list_add(ac_list *self, void *item)
{
